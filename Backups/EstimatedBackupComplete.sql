...
--WHERE command IN ('RESTORE DATABASE','BACKUP DATABASE','DbccSpaceReclaim','DbccFilesCompact')
WHERE command IN ('RESTORE DATABASE','BACKUP DATABASE','DbccSpaceReclaim','DbccFilesCompact','DBCC')