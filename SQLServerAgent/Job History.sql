...
,sysjh.run_duration StepDuration --Elapsed time in the execution of the job or step in HHMMSS format.
,STUFF(STUFF(REPLACE(STR(sysjh.run_duration,7,0),' ','0'),4,0,':'),7,0,':') AS LastRunDuration
...
WHERE sysjh.step_id = 0
-- AND sysjh.job_id = 'F6A3F97E-AB5A-4ADF-8749-455C769F87D6'