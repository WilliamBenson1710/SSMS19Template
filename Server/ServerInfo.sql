...
,LEFT(CONVERT(NVARCHAR(40), SERVERPROPERTY('ProductVersion')),4) AS ProductVersion
...
,CAST(SERVERPROPERTY('InstanceDefaultBackupPath') AS NVARCHAR(150)) AS [DefaultBackupPath]
,CAST(SERVERPROPERTY('InstanceDefaultDataPath') AS NVARCHAR(150)) AS [DefaultDataPath]
,CAST(SERVERPROPERTY('InstanceDefaultLogPath') AS NVARCHAR(150)) AS [DefaultLogPath]
